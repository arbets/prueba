        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a type="button" class="w-100 btn btn-lg btn-outline-primary" href="<?php echo base_url(); ?>usuarios/registrar" >Agregar Usuarios</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a type="button" class="w-100 btn btn-lg btn-primary" href="<?php echo base_url(); ?>usuarios/listar">Ver Reportes</a>
                </div>
            </div>
        </div>
    </div>
